...
const [selectedPayroll, setSelectedPayroll] = useState<any>(null);
  ...
  const fetchPayroll = async () => { try { setLoading(true); const res = await getPayroll(); const rows = Array.isArray(res.data) ? res.data : Array.isArray(res.data?.data) ? res.data.data : []; setData(rows); } catch { } finally { setLoading(false); } };
  useEffect(() => {
    fetchPayroll();
    const close = () => {
